...
import com.empmanagement.dao.PerformanceManagementDAO;
...
public class PerformanceManagementServiceImpl implements PerformanceManagementService {
    ...
    public List<ManagerEmployeeRelation> getManagers(String empId){
        List<ManagerEmployeeRelation> managerEmployeeRelations=performanceManagementDAO.getManagers(empId);
    ...
    public boolean checkPendingReviews(String empId){
        ...
        List<PerformanceManagement> performanceManagementList=getReviews(empId);
